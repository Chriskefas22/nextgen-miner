...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${baseUrl}/miner-catalog`, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/faq`, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/referrals`, changeFrequency: 'monthly', priority: 0.6 },
    ...
    { url: `${baseUrl}/legal/disclaimer`, changeFrequency: 'yearly', priority: 0.4 },
  ];
}
