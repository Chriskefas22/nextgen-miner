...
export default function RoomsPage() {
    ...
    useCallback(
      async () => {
        ...
        try {
          ...
          if (!user) {
            throw new Error(
              'Please sign in to manage your Rooms.',
            );
          }
          ...
          setData(
            roomsResult.data as RoomsSnapshot,
          );
  ...
  async function returnToInventory(
    ...
    try {
      ...
      setMessage(
        `${slot.name} returned to Inventory from Room.`,
      );
            ...
            >
              <div>
                ...
                <p>
                  ...
                  expand its capacity,
                  or unlock another
                  Room when your fleet
                  outgrows the current
                  workspace.
                </p>
              </div>
                ...
                <button
                  ...
                  disabled={
                    busy ===
                      'create' ||
                    balance <
                      data.next_room_unlock_price_diamond
                  }
                  onClick={() =>
                    void createRoom()
                  }
                ...
                return (
                  ...
                  >
                        ...
                        (
                          ...
                          slot ? (
                            <div
                              ...
                              title={`${slot.name} Lv${slot.level} · ${slot.hashrate} H/s`}
                            >
                              <img
                                src={imagePath(
                                  slot.image_path,
                              ...
                              <button
                                ...
                                title="Return this miner to Inventory"
                                aria-label={`Return ${slot.name} to Inventory`}
                              >
                                {busy ===
                                `return:${slot.user_miner_id}` ? (
                                  '…'
                    ...
                    >
                      ...
                      />
                      Tap the return icon
                      on any deployed rack
                      miner to move it back
                      to Inventory.
                    </div>
                  </section>
                );
