...
* TIMESTAMP MINING
* 
* Mining is calculated by Supabase using last_accrual_at.
* The browser clock is never used as the source of truth.
* 
* This call is intentionally non-fatal:
* if the mining pool has no funded budget, the dashboard
* must still load normally.
  */
...
if (accrualError) {
console.error('[DashboardMiningAccrual]', accrualError);
}
