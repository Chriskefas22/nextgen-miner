...
export const metadata = {
  ...
  description: 'Detailed terms governing accounts, virtual miners, rewards, wallet activity, referrals, security and platform changes.',
  ...
  return (
    ...
    >
      <section className="public-card public-hero">
        ...
        <h2>6. Rewards</h2><p>Rewards depend on active platform economics, available reward resources, eligibility and server-side controls. Displayed estimates are not final credits and rewards are not guaranteed income, profit or investment returns.</p>
        <h2>7. Campaigns and bonuses</h2><p>Promotional campaigns may have limited allocations, eligibility, verification and expiry conditions. The database campaign state is authoritative.</p>
        <h2>8. Deposits</h2><p>Deposits can remain pending until the applicable review process is completed. Submission does not guarantee approval or credit.</p>
        <h2>9. Withdrawals</h2><p>Withdrawals are available only where the current platform rules allow them. Eligibility can depend on current minimums, qualifying top-up requirements, supported payout routes, account status and review controls.</p>
        <h2>10. Referral program</h2><p>Referral attribution is controlled by server-side records. Self-referrals, duplicate-account abuse and attempts to circumvent qualification rules are prohibited.</p>
        <h2>11. Prohibited activity</h2><p>Fraud, bots or automated abuse, transaction manipulation, unauthorized access, bug exploitation, reward manipulation, identity abuse and spam are prohibited.</p>
        <h2>12. Suspension and correction</h2><p>The operator may reject, suspend, correct or restrict activity when necessary to protect users, transaction accuracy, platform integrity or security, subject to applicable law.</p>
