...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  const drawerStyle = open
    ? ({
        ...
        zIndex: 100,
        overflowY: 'auto',
        boxShadow: '18px 0 45px rgba(0,0,0,.42)',
    ...
    >
      <div className="sidebar-head">
        ...
        <button
          ...
          onClick={onClose}
          style={open ? { display: 'grid' } : undefined}
        >
          ×
        </button>
      </div>
      ...
      <div className="sidebar-footer">
        ...
        >
          ...
          <div>
            <b>{userName}</b>
            <small>
              {minerLevel === null ? 'No miner yet' : `Level ${minerLevel}`}
            </small>
          </div>
          <span className="dot" />
        </Link>
