...
begin
  ...
  return jsonb_build_object(
    ...
    'reserve',jsonb_build_object('balance_usd',round(reserve_balance,8),'in_10d_usd',round(reserve_in_10d,8),'out_10d_usd',round(reserve_out_10d,8),'coverage_ratio',coalesce((capacity->>'reserve_coverage_ratio')::numeric,0),'status',coalesce(pool.reserve_status,capacity->>'reserve_status','UNKNOWN')),
